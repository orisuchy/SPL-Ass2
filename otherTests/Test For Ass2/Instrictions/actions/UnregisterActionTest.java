...
public class UnregisterActionTest {
    ...
    public void testAction() {
       ...
       createParticipate("1","D","10");
        ...
        createParticipate("1","A","90");
        createAction("1","A");
        createParticipate("1","A","80");
        createAction("1","A");
        createParticipate("1","A","70");
        createAction("1","A");
        createParticipate("1","A","90");
        createAction("1","A");
        ...
        assertEquals(A.createHash(new String[] {"B","C","D"},new Integer[] {-1,20,10}),
        ...
        assertEquals(A.createHash(new String[] {"A","D"},new Integer[] {60,30}),
    ...
    public static void createAction(String student,String courseName){
        UnregisterAction unregister = new UnregisterAction(
                "Adding",student,courseName);
