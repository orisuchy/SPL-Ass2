...
public class ActorThreadPoolTest {
    ...
    public static class Transmission extends Action<String>{
        int amount;
        String sender;
        String receiver;
        String receiverBank;
        ...
        protected void start(){
            ...
            then(actions,()->{
               if(actions.get(0).getResult().get()){
                   ((BankState)actorPrivateState).amountSended(sender,amount);
    ...
    public static class Confirmation extends Action<Boolean>{
        ...
        @Override
        protected void start(){
            ((BankState)actorPrivateState).amountReceived(receiver,amount);
            complete(true);
        }
