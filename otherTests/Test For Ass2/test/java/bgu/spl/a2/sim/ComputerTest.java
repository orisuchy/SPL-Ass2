...
public class ComputerTest {
    ...
    public void testMethods(){
        ...
        // Pass only 1
        HashMap<String, Integer> stdu1 = createStudentGrades(new Integer[] {57,56,100});

        // Pass 1 and 2
        HashMap<String, Integer> stdu2 = createStudentGrades(new Integer[] {57,56,100,58,60});

        // Pass only 1
        HashMap<String, Integer> stdu3 = createStudentGrades(new Integer[] {55,56,100,58,60});

        // Pass only 1,2 and 3
        HashMap<String, Integer> stdu4 = createStudentGrades(new Integer[] {56,56,70,58,60,90,75,80,99,120});

        // Pass only 1 and 2
        HashMap<String, Integer> stdu5 = createStudentGrades(new Integer[] {56,56,70,58,60,90,75,20,99,120});

        // Pass only 1
        HashMap<String, Integer> stdu6 = createStudentGrades(new Integer[] {56,56,55,58,60,90,75,80,99,120});

        // Pass only 1
        HashMap<String, Integer> stdu7 = createStudentGrades(new Integer[] {10,56,59,58,60,90,75,80,99,120});

        // Pass only 1 and 2
        HashMap<String, Integer> stdu8 = createStudentGrades(new Integer[] {57,56,59,58,60,90,75,80,99,55});
